    ...
    return (
        <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="flex flex-col gap-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                    <button className="cursor-pointer border-1 p-1 border-gray-300"
            ...
            <button className="ring-1 ring-gray-400 shadow-lg text-gray-800 px-4 py-2
                rounded-md flex items-center justify-center gap-2 text-sm font-medium cursor-pointer">
